/*vitua functions and Runtime Polymorphism in C++ | Set 1 (Introduction)
...
class TeamLeader: public Employee {
    ...
    {  
        ...
        cout<<"This is Team Leader raiseSalary";
        
    /* Manager specific raise salary code, may contain
          increment of manager specific incentives*/  }
 
    virtual void promote()
    { cout<<"This is Team Leader Promotion"; }
};
...
int main()
{
    Manager m;
    TeamLeader tl;
    Employee* myArray[2] = { &m, &tl};

    globalRaiseSalary(myArray, 2);
    return 0;
}
